...
const Project = () => {
    ...
    initial={{ opacity: 0, x: -200 }}
     ...
     className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
      ...
      <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Crafting Spaces,Building Legacies-Explore our portofolio</p>
    {/*--slider buttons--*/}
   <div className='flex justify-end items-center mb-8 '>
    <button onClick={prevProject}
    className='p-3 bg-gray-200 rounded mr-2 'aria-label='Previous Project cursor-pointer'>
        <img src={assets.left_arrow} alt="Previous" />
    </button>
    <button onClick={nextProject}
    className='p-3 bg-gray-200 rounded mr-2 'aria-label='Next Project cursor-pointer'>
